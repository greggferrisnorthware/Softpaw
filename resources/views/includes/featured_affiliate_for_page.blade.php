...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <span class="awesome">Softpaw Top Picks</span>
        </div>
    </div>
</div>
...
<div class="view-all-area">
    <div class="row featured justify-content-center">
        @php $count = 1; @endphp
        @foreach($featured_affiliates_home as $featured_affiliate)
            @if($featured_affiliate->price > '100.00')
                @if($count < 6)
                <div class="col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                    <a class="product" rel="sponsored" href="{{ $featured_affiliate->link }}" target="_blank">
                        ...
                        @if($featured_affiliate->status->status != 'none') 
