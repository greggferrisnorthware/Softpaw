        ...
        $category .= '<div class="row justify-content-center">';
            foreach($affiliates as $affiliate) {
                if(!empty($_POST['allCategory'])) {
                    if(stripos($affiliate->name, $_POST['allCategory']) !== false || stripos($affiliate->category->category, $_POST['allCategory']) !== false || stripos($affiliate->pet->pet, $_POST['allCategory']) !== false || stripos($affiliate->brand->brand, $_POST['allCategory']) !== false || stripos($affiliate->spec_1, $_POST['allCategory']) !== false || stripos($affiliate->spec_2, $_POST['allCategory']) !== false || stripos($affiliate->spec_3, $_POST['allCategory']) !== false || stripos($affiliate->spec_4, $_POST['allCategory']) !== false) {
